...
class Material(models.Model):
    name = models.CharField('Name', max_length=100)
    embedded = models.TextField('Embedded', blank=True)
...
class Comment(models.Model):
    announcement = models.ForeignKey(Announcement, verbose_name='Announcement',
    ...
    def __str__(self):
        return 'Comment from %s to %s' % (self.user, self.announcement)
