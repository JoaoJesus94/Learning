...
/* @var $userProfileModel common\models\Userprofile */
...
?>
    <div class="userprofile-view center-tables">
        ...
        <?php if (Yii::$app->user->can('editProfile', ['userProfile' => $userProfileModel])) {
            echo Html::a('Edit Profile', ['update', 'id' => $userProfileModel->id], ['class' => 'btn btn-primary', 'style' => 'float:right']);
        } ?>
