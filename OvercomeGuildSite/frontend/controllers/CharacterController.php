...
class CharacterController extends Controller
{
    ...
    public function actionClasses()
    {
        if (isset($_POST['depdrop_parents'])) {
            ...
            if ($parents != null) {
                ...
                if ($parents[0] == 'Lightforged Draenaei') {
                    $out = [
                        ['id' => 'Hunter', 'name' => 'Hunter'],
                        ['id' => 'Mage', 'name' => 'Mage'],
                        ['id' => 'Paladin', 'name' => 'Paladin'],
        ...
        $races = [
            ...
            'Allied Races' =>
                ['Dark Iron Dwarf' => 'Dark Iron Dwarf', 'Kul Tiran Human' => 'Kul Tiran Human',
                    'Lightforged Draenaei' => 'Lightforged Draenaei', 'Void Elf' => 'Void Elf']
        ];
    ...
    {
        $model = $this->findModel($id);
        if (Yii::$app->user->can('editOwnCharacter', ['userCharacter' => $model])) {
            if ($model->load(Yii::$app->request->post()) && $model->save()) {
    ...
    public function actionDelete($id, $userprofile_id)
    {
        ...
        if (Yii::$app->user->can('deleteOwnCharacter', ['userCharacter' => $model])) {
            $model->delete();
